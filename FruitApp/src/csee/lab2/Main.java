...
public class Main {
	...
	public static void main(String[] args) {
		...
		fl.add(new Fruit(104, "Blueberry", 2500));
		fl.add(new Fruit(105, "Watermelon", 3000));
		fl.add(new Fruit(106, "Melon", 4000));
		fl.add(new Fruit(107, "Raspberry", 5000));
		fl.add(new Fruit(108, "Strawberry", 6000));
		fl.add(new Fruit(109, "Peach", 4500));
		fl.add(new Fruit(110, "Mandarin", 5500));
